...
const perguntas = [
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "A educação é a melhor ferramenta para conscientizar a sociedade.",
            ...
            {
                texto: "A educação não interfere na conscientização da sociedade.",
                afirmacao: "Dificuldade em conciliar trabalho com estudo. As barreiras que ainda existem em relação ao acesso e/ou conexão a equipamentos que permitam essa tal formação."
            } 
        ]
    }
]
